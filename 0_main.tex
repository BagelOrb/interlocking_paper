...
However, dovetail type interlocking locks movement in only two of three dimensions, introduces extrusion discontinuities and relies on the material's resistance to deformation, which is difficult to model.
