...
\begin{abstract}
\revise{Dual-material desktop Fused Deposition Modeling (FDM) systems}{Material Extrusion (MEX) systems with dual-material capability} can unlock interesting applications when flexible and rigid materials are combined.
