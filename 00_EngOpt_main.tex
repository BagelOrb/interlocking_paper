...
\begin{abstract}
When using incompatible materials in FDM 3D printing, the materials do not adhere well to each other.
This paper aims to optimize the design of mechanically interlocking structures by maximizing its strength in order to adhere incompatible materials together as good as possible.
\end{abstract}
...
\newcommand{\wmina}{w_{a, \text{min}}}
\newcommand{\wminb}{w_{b, \text{min}}}
\newcommand{\wminm}{w_{m, \text{min}}}
\newcommand{\Lmax}{L_\text{max}}

\newcommand{\sigmafail}[1]{\sigma_{#1, \text{y}}}
\newcommand{\sigmafailz}[1]{\sigma_{#1, \text{yZ}}}
\newcommand{\taufail}[1]{\tau_{#1, \text{y}}}
\newcommand{\tauz}[1]{\tau_{#1, \text{yZ}}}
...
\input{04_EngOpt_strategy}
\input{05_EngOpt_initOpt}
\input{06_EngOpt_actualOpt}
\input{07_EngOpt_DiscussionRecommendations}
\input{08_EngOpt_Conclusion}
