...
Using multiple materials to create colo\revise{u}{}red surface imagery is commonly performed using MultiJet technologies, but can alternatively be performed using inkjet techniques\cite{sachs1994three} or even DLP resin printers \cite{Zhou2011Development}.
Such techniques can even be extended to deal with translucency\cite{Brunton2018} and gloss\cite{elkhuizen2019gloss}.
Several colo\revise{u}{}r printing techniques have also been proposed for \revise{FDM}{MEX}.\cite{reiner2014dual,Song2019,Kuipers2018}
...
Literature on interlocking patterns for adhesion between incompatible materials in \revise{FDM}{MEX} 3D printing has focussed on \revise{extruded}{extended} 2D interlocking dovetail type of designs,
...
\revise{}{However, the dovetail shapes are often relatively large, which limits their applicability and if they are shrunk the widening of the dovetails would introduce discontinuous toolpaths.}
\revise{Such interlocking designs are extrusions of 2D shapes and therefore they allow for translation along the extrusion axis, so these type of interlocking designs do not lock all axes.}
...
%\revise{}{Moreover, it is unclear how dovetail type interlocks would be applicable to non-vertical interfaces.}
\revise{}{By considering aspects of the interlock along the Z axis, the dovetail interlocking concept can be expanded into 3D interlocking structures.}
%\revise{}{The lack of consideration of the Z axis limits dovetail interlocking designs and their applicability.}
...
The lattice interlocks all degrees of freedom in 3D space and as such lends itself to interfaces between two bodies of different material of arbitrary orientation.
...
Optimizing the lattice for interfaces of arbitrary orientation is left as future work.
}
