...
In order to solve this we set \cref{eq:c4} active and \todo{we will show} that \cref{eq:c3} (or the others) are not violated.
...
\begin{align*}
	...
	%\frac{ 3 F }{ 4 \cdot 2 v^m h_\text{c}} &\le \sigma^m_\text{fail} \\
...
\begin{align*}
	%\frac{ 3 F }{ 4 v^a h_\text{c} \sigma^a_\text{fail} }  \max{\left( 2, \frac{w^b}{v^a} \right)} \le 1  \bigvee
	%\frac{ 3 F }{ 4 v^b h_\text{c} \sigma^b_\text{fail} }  \max{\left( 2, \frac{w^a}{v^b} \right)} \le 1  \\
	%\min{\left( \frac{ 3 F }{ 4 v^a h_\text{c} \sigma^a_\text{fail} }  \max{\left( 2, \frac{w^b}{v^a} \right)}
	%, \frac{ 3 F }{ 4 v^b h_\text{c} \sigma^b_\text{fail} }  \max{\left( 2, \frac{w^a}{v^b} \right)} \right)} \le 1  \\
	%\frac{3 F}{4 h_\text{c}}  \min{\left( \frac{ 1 }{ v^a \sigma^a_\text{fail} }  \max{\left( 2, \frac{w^b}{v^a} \right)}
	%, \frac{ 1 }{ v^b \sigma^b_\text{fail} }  \max{\left( 2, \frac{w^a}{v^b} \right)} \right)} \le 1  \\
	%\frac{3 F}{4 h_\text{c}}  \min{\left( \frac{ \max{\left( 2, \frac{w^b}{v^a} \right)} }{ v^a \sigma^a_\text{fail} }  
	%, \frac{ \max{\left( 2, \frac{w^a}{v^b} \right)} }{ v^b \sigma^b_\text{fail} }   \right)} \le 1  \\
	\frac{3 F}{4 h_\text{c}}  \min{\left( \frac{ \max{\left( 2, \frac{w^b}{v^a} \right)} }{ v^a \sigma^a_\text{fail} }  
...
\begin{align*}
	...
	%	\min{\left( \frac{ 3 F }{ 4 v^a h_\text{c} \tau^a } , \frac{ 3 F }{ 4 v^b h_\text{c} \tau^b }  \right)} - 1 &\le 0 \\
...
\begin{align*}
	...
	%\frac{3 w_\text{min}^a}{h_\text{min} \sigma_\text{fail}^a v^a} &= \frac{h_\text{min}}{\left(h_\text{f}\right)^2 \sigma_\text{fail}^b} \\
	%\frac{h_\text{min} \sigma_\text{fail}^a v^a}{3 w_\text{min}^a} &= \frac{\left(h_\text{f}\right)^2 \sigma_\text{fail}^b}{h_\text{min}} \\
	%h_\text{min} \sigma_\text{fail}^a v^a &= \frac{\left(h_\text{f}\right)^2 \sigma_\text{fail}^b  3 w_\text{min}^a  }{  h_\text{min}} \\
	%v^a &= \frac{h_\text{min} \sigma_\text{fail}^a \left(h_\text{f}\right)^2 \sigma_\text{fail}^b  3 w_\text{min}^a  }{  h_\text{min}} \\
	%v^a &= \sigma_\text{fail}^a \left(h_\text{f}\right)^2 \sigma_\text{fail}^b  3 w_\text{min}^a  \\
