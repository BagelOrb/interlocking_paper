...
\begin{align*}
	%\frac{ F }{ v^a \hc \sigmafail^a }  \max{\left( \frac12 \sqrt{3}, \frac{w^b}{2v^a} \right)} \le 1  \bigvee
	%\frac{ F }{ v^b \hc \sigmafail^b }  \max{\left( \frac12 \sqrt{3}, \frac{w^a}{2v^b} \right)} \le 1  \\
	%\min{\left( \frac{ F }{ v^a \hc \sigmafail^a }  \max{\left( \frac12 \sqrt{3}, \frac{w^b}{2v^a} \right)}
	%, \frac{ F }{ v^b \hc \sigmafail^b }  \max{\left( \frac12 \sqrt{3}, \frac{w^a}{2v^b} \right)} \right)} \le 1  \\
	%\frac{F}{\hc}  \min{\left( \frac{ 1 }{ v^a \sigmafail^a }  \max{\left( \frac12 \sqrt{3}, \frac{w^b}{2v^a} \right)}
	%, \frac{ 1 }{ v^b \sigmafail^b }  \max{\left( \frac12 \sqrt{3}, \frac{w^a}{2v^b} \right)} \right)} \le 1  \\
	%\frac{F}{\hc}  \min{\left( \frac{ \max{\left( \frac12 \sqrt{3}, \frac{w^b}{2v^a} \right)} }{ v^a \sigmafail^a }  
	%, \frac{ \max{\left( \frac12 \sqrt{3}, \frac{w^a}{2v^b} \right)} }{ v^b \sigmafail^b }   \right)} \le 1  \\
