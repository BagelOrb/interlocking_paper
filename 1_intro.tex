...
\begin{itemize}
	\item An interlaced genus interlocking microstructure (IGIM) for continuous extrusion
	\item Two types of interlocking designs based on IGIM
	\item Simplified analytical models for estimating tensile properties
	\item A simulation framework for optimizing interlocking structures for tensile strength
\end{itemize}
