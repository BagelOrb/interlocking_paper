...
\title{IGIM: Interlaced Genus-Interlocking Microstructure to enhance adhesion between chemically incompatible 3D printing filaments}
...
However, when incompatible materials are concerned the chemical adhesion between two materials can be negligible.
...
3D interlocking with high genus topology locks all 3 dimensions and depends less on material specifics.
Requiring a high genus topology to satisfy (semi-)continuous extrusion constraints might seem challenging.
...
We optimize the structure for PolyPropylene and PLA against a horizontal tensile force.
