...
We develop analytical models for optimizing the ultimate tensile strength of the ITIM lattice in two different orientations w.r.t. the interface.
The analytical models are applied to polypropylene (PP) and polylactic acid (PLA) and verified by FEM simulations and physical tensile experiments.
