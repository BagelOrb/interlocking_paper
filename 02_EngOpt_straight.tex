...
%	\frac{ F w^m }{ 2 v^m w^m w} &\le \tauz^m							&&\text{ Shear failure } M_z^m  \label{eq:c_shear_z} \\
...
\begin{align*}
	%	\sqrt{\frac12 \left(  \left(\sigma_{11} - \sigma_{22}\right)^2  +  \left(\sigma_{22} - \sigma_{33}\right)^2  +  \left(\sigma_{33} - \sigma_{11}\right)^2   +   6\left(\sigma_{23}^2 + \sigma_{31}^2 + \sigma_{12}^2\right)\right)}&< \sigmafail \\
	%	\sqrt{\frac12 \left(  \left(\sigma_{11} - \sigma_{22}\right)^2  +  \sigma_{22}^2  +  \sigma_{11}^2   +   6\left(\sigma_{31}^2 + \sigma_{12}^2\right)\right)}&< \sigmafail \\
	%	\sqrt{\frac12 \left(  \sigma_{11}^2 + \sigma_{22}^2 - 2\sigma_{11}\sigma_{22} +  \sigma_{22}^2  +  \sigma_{11}^2   +   6\left(\sigma_{31}^2 + \sigma_{12}^2\right)\right)}&< \sigmafail \\
