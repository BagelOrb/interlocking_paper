...
The latter value is optimized for tensile failure along $\myz{b}$.
...
The boundaries of these two structures and in half a TPLA lobe, because that is the stiffer material.
In order to meet the minimum width constraint there, the sides of the specimen are extruded by $\wmin{a}$.


\subsection{Results}
figure of some stress-strain graphs

max strength calculation; two types: idealized and actual
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{sources/testing/results.jpg}
