...
However, when chemically incompatible materials are used the chemical adhesion between two materials can be negligible.
...
\newcommand{\myz}[1]{M_{\text{x}}^#1}
\newcommand{\mxz}[1]{M_{\text{y}}^#1}
\newcommand{\mxy}[1]{M_{\text{z}}^#1}
