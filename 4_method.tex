...
\begin{figure}
	...
	\begin{subfigure}[B]{.36\columnwidth}\centering
		...
		\caption{The IGIM lattice \\ (exploded view)}
		\label{fig:basic_structure_single_mat}
	\end{subfigure}
	\begin{subfigure}[B]{.36\columnwidth}\centering
		\includegraphics[height=\figheight]{sources/method/connectivity_lattice.jpg}
		\caption{Connectivity graph of the IGIM lattice}
		\label{fig:connectivity_graph}
	\end{subfigure}
	\caption{Classical 2D interlocking versus IGIM 3D interlocking.}
