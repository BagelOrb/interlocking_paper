...
If the product design only allows for an interface region less than \SI{2.4}{\milli\meter} long, the straight orientation is expected to outperform the diagonal orientation of the ITI\revise{M}{L} lattice.
