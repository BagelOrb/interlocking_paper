...
Moreover, the minimal manufacturable design is already at \SI{84}{\percent} of the ultimate stress compared to twice the total allowed length $L_{max}$.
...
Manufacturing constraints mean that $\hf$ should be constrained to integer values of $h_{min}$.
