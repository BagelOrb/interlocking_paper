...
\begin{figure}
	...
	\begin{subfigure}[B]{.6\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/simulation/mesh-straight.png}
		\caption{Straight ITIM}
	\end{subfigure}
\hspace{-.5cm}
	\begin{subfigure}[B]{.39\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/simulation/mesh-diagonal.png}
...
\begin{figure*}
	...
	\begin{subfigure}[B]{.48\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/simulation/r1-lmax3.6.png}
		\caption{$\lmax=\SI{3.6}{\milli\meter}; \hf=\SI{0.8}{\milli\meter}$}
	\end{subfigure}
	\begin{subfigure}[B]{.48\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/simulation/r1-lmax3.0.png}
		\caption{$\lmax=\SI{3.0}{\milli\meter}; \hf=\SI{0.8}{\milli\meter}$}
	\end{subfigure}
	\begin{subfigure}[B]{.48\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/simulation/r1-lmax2.4.png}
		\caption{$\lmax=\SI{2.4}{\milli\meter}; \hf=\SI{0.7}{\milli\meter}$}
	\end{subfigure}
	\begin{subfigure}[B]{.52\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/simulation/r1-lmax1.8.png}
...
\begin{figure*}
	\centering
	\includegraphics[width=.8\textwidth]{interlocking/sources/simulation/model_accuracy.pdf}
...
\begin{figure}
	...
	\begin{subfigure}[B]{.49\columnwidth}
		\centering	
		\includegraphics{interlocking/sources/simulation/diagonal_sim_response.jpg}
		\caption{Simulation results.}
		\label{interlocking:fig:sim_diagonal_model}
	\end{subfigure}
	\begin{subfigure}[B]{.49\columnwidth}
		\centering
		\includegraphics{interlocking/sources/simulation/model_accuracy_diagonal.pdf}
