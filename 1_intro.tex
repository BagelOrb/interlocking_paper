...
\begin{figure}
	...
	\end{subfigure}
	\caption{Interlocking principles; exploded view with a section cut at the top layer. The dovetail can be disassembled by translation; the cubic lattice causes highly discontinuous extrusion on some layers; \revise{the proposed}{} ITI\revise{M}{L} \revise{lattice }{}solves these problems.}
...
and \revise{out of plane}{if the dovetail is not accompanied by horizontal features above an below} the pieces \revise{can}{could} be disassembled by translation alone.
...
\revise{In order to overcome these limitations}{Therefore}, we propose \emph{topological interlocking}\revise{.
