...
\input{interlocking/5_simulation}
...
\begin{figure}
	...
	\begin{subfigure}[B]{.26\columnwidth}
		\centering
		\includegraphics[width=\figheight,rotate=90]{interlocking/sources/testing/straight_gcode.jpg}
		\caption{Straight ITIM}
		\label{interlocking:fig:gcode_straight}
	\end{subfigure}
	\begin{subfigure}[B]{.26\columnwidth}
		\centering
		\includegraphics[width=\figheight,rotate=90]{interlocking/sources/testing/diagonal_gcode.jpg}
		\caption{Diagonal ITIM}
		\label{interlocking:fig:gcode_diagonal}
	\end{subfigure}
	\begin{subfigure}[B]{.22\columnwidth}
		\centering
		\includegraphics[width=\figheight,rotate=90]{interlocking/sources/testing/suture_gcode.jpg}
		\caption{Trap. suture}
		\label{interlocking:fig:gcode_suture}
	\end{subfigure}
	\begin{subfigure}[B]{.22\columnwidth}
		\centering
		\includegraphics[width=\figheight,rotate=90]{interlocking/sources/testing/jigsaw_gcode.jpg}
		\caption{Jigsaw}
...
\begin{figure}
	...
	\begin{subfigure}[B]{.24\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{interlocking/sources/testing/straight_sample.jpg}
		\caption{Example print mesh near optimum}
		\label{interlocking:fig:test_straight_boundary_cells}
	\end{subfigure}
	\begin{subfigure}[B]{.24\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{interlocking/sources/testing/straight_print.jpg}
		\caption{Example print near broken optimum}
	\end{subfigure}
	\begin{subfigure}[B]{.5\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{interlocking/sources/testing/straight_sample_points.pdf}
...
\begin{figure}
	...
	\begin{subfigure}[B]{.24\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{interlocking/sources/testing/diagonal_sample.jpg}
		\caption{Example print mesh}
		\label{interlocking:fig:test_diagonal_boundary_cells}
	\end{subfigure}
	\begin{subfigure}[B]{.24\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{interlocking/sources/testing/diagonal_print.jpg}
...
\begin{figure}
	...
	\begin{subfigure}{.49\columnwidth}
		\includegraphics{interlocking/sources/method/suture_model_v5.pdf}
		\caption{Trapezoidal suture}
		\label{interlocking:fig:suture}
	\end{subfigure}
	\begin{subfigure}{.49\columnwidth}
		\includegraphics{interlocking/sources/method/jigsaw_model_v5.pdf}
		\caption{Jigsaw}
...
\begin{figure*}
	\centering
	\includegraphics[width=\textwidth]{interlocking/sources/testing/results.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{interlocking/sources/testing/stress_displacement_comparison.pdf}
...
\begin{figure}
	...
	\begin{subfigure}[B]{.99\columnwidth}
		\centering
		\includegraphics[width=\figwidth]{interlocking/sources/testing/j1_cropped.jpg}
		\includegraphics[width=\figwidth]{interlocking/sources/testing/j2_cropped.jpg}
		\includegraphics[width=\figwidth]{interlocking/sources/testing/j3_cropped.jpg}
		\includegraphics[width=\figwidth]{interlocking/sources/testing/j4_cropped.jpg}
		\includegraphics[width=\figwidth]{interlocking/sources/testing/j5_cropped.jpg}
	...
	\begin{subfigure}[B]{.28\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/testing/a1_cropped.jpg}
		\caption{Straight ITIM whole}
		\label{interlocking:fig:failures_whole}
	\end{subfigure}
	\begin{subfigure}[B]{.28\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/testing/v1_cropped.jpg}
		\caption{Diagonal ITIM $1.2$}
		\label{interlocking:fig:failures_diagonal}
	\end{subfigure}
	\begin{subfigure}[B]{.18\columnwidth}
		\centering
		\includegraphics[height=\figheight]{interlocking/sources/testing/jigsaw_cropped.jpg}
		\caption{Jigsaw $1.8$}
		\label{interlocking:fig:failures_jigsaw}
	\end{subfigure}
	\begin{subfigure}[B]{.22\columnwidth}
		\centering
		\includegraphics[width=\figheight,rotate=90]{interlocking/sources/testing/suture_wide_cropped.jpg}
