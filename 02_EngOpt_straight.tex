...
\begin{align*}
	...
	%3\left( \left( \frac{d_y^m F}{2 v^m \hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz} \frac{ F }{ 2 v^m w^m}  \right)^2\right) &< \sigmafail^2\\
	%3\left(\frac{F}{2v^m}\right)^2 \left( \left( \frac{d_y^m }{\hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz} \frac{ 1 }{ w^m}  \right)^2\right) &< \sigmafail^2\\
	%\sqrt{3} \frac{F}{2v^m} \sqrt{ \left( \frac{d_y^m }{\hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } &< \sigmafail\\
	%\sqrt{3} \frac{F}{2v^m} \sqrt{ \left( \frac{1 }{\hc} \frac{w^{\neg m}}{w} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } &< \sigmafail\\
	%\sqrt{3} \frac{F}{2v^m} \sqrt{ \left( \frac{w^{\neg m}}{w \hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } &< \sigmafail\\
	%\frac{2v^m}{F} \frac{1}{ \sqrt{3} \sqrt{ \left( \frac{w^{\neg m}}{w \hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } } &> \frac{1}{\sigmafail}\\
	%\frac{2v^m}{F} \frac{\sigmafail}{ \sqrt{3} \sqrt{ \left( \frac{w^{\neg m}}{w \hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } } &> 1 \\
	%1 - \frac{2v^m}{F} \frac{\sigmafail}{ \sqrt{3} \sqrt{ \left( \frac{w^{\neg m}}{w \hc} \right)^2 + \left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } } &< 0 \\
	%1 - \frac{2v^m}{F} \frac{\sigmafail}{ \sqrt{ 3\left( \frac{w^{\neg m}}{w \hc} \right)^2 + 3\left(  \frac{\sigmafail}{\sigmafailz w^m} \right)^2 } } &< 0 \\
...
\begin{align*}
	...
	\gca: & 1 - \frac{2v^a \sigmafail}{ F \sqrt{ 3\left( \frac{w^b}{w \hc} \right)^2 + 3\left(  \frac{\sigmafail}{\sigmafailz 2\wmin^a} \right)^2 } } \le 0 \\
